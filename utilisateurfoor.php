          ...
          <div class="col-md-9 blog-main mt-3">
            ...
            <div class="card card-b-blue mb-3">
              ...
              <div class="card-header p-1">
                <h1 class="m-1">المؤهلات العلمية</h1>
              </div>
              <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="card text-white bg-secondary">
                      <div class="list-group list-group-flush text-center">
                        <a href="infor_utili.php" class="list-group-item list-group-item-action px-1 py-3">
                          <img src="https://depot.emploi-public.ma/imgs/agreement.png" alt="معلوماتي الشخصية" class="unveil-loaded"><br>
                        </a>
                      </div>
                      <div class="list-group list-group-flush text-center">
                        <a href="utilisateurfive.php" class="list-group-item list-group-item-action p-2">
                  ...
                  <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card text-white bg-secondary">
                      ...
                      <div class="list-group list-group-flush text-center">
                        <a href="utilisateursix.php" class="list-group-item list-group-item-action p-2">
                  ...
                  <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card text-white bg-secondary">
                      <div class="list-group list-group-flush text-center">
                        <a href="" class="list-group-item list-group-item-action px-1 py-3">
                          <img src="https://depot.emploi-public.ma/imgs/agreement.png" alt="سيرتي الذاتية" class="unveil-loaded"><br>
                        </a>
                      </div>
                      <div class="list-group list-group-flush text-center">
                  ...
                  <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card text-white bg-secondary">
                      <div class="list-group list-group-flush text-center">
                        <a href="" class="list-group-item list-group-item-action px-1 py-3">
                          <img src="https://depot.emploi-public.ma/imgs/agreement.png" alt="ترشيحاتي" class="unveil-loaded"><br>
                        </a>
                      </div>
                      <div class="list-group list-group-flush text-center">
                        <a href="" class="list-group-item list-group-item-action p-2">
                          معلومات حول الاشغال او الدراسات المنجزة (ان وجدت)
                  ...
                  <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card text-white bg-secondary">
                      <div class="list-group list-group-flush text-center">
                        <a href="" class="list-group-item list-group-item-action px-1 py-3">
                          <img src="https://depot.emploi-public.ma/imgs/agreement.png" alt="" class="unveil-loaded"><br>
                        </a>
                      </div>
                      <div class="list-group list-group-flush text-center">
                        <a href="" class="list-group-item list-group-item-action p-2">
                          معلومات حول الوضعية المهنية الحالية )بالنسبة للمترشحين العاملين (
